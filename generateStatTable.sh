...
echo "label,numOfQueries,numOfExecutions,begin,end,entropyForQueries,numOfHosts,numOfTemplates,entropyForTemplates,entropyForHosts" >$CSV_OUTPUT
...
| awk 'BEGIN { FS=","; OFS="," } {
    ...
    print label,numOfQueries,numOfExecutions,begin,end,entropyForQueries,numOfHosts,numOfTemplates,entropyForTemplates,entropyForHosts;
}' >>$CSV_OUTPUT
